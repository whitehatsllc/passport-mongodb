...
namespace Whitehatsllc\PassportMongodb\Guards;
...
use Whitehatsllc\PassportMongodb\TransientToken;
use Whitehatsllc\PassportMongodb\TokenRepository;
use Whitehatsllc\PassportMongodb\ClientRepository;
...
class TokenGuard
{
     ...
     *
     * @var \Whitehatsllc\PassportMongodb\TokenRepository
     */
    protected $tokens;
     ...
     *
     * @var \Whitehatsllc\PassportMongodb\ClientRepository
     */
    protected $clients;
     ...
     * @param  \Whitehatsllc\PassportMongodb\TokenRepository  $tokens
     * @param  \Whitehatsllc\PassportMongodb\ClientRepository  $clients
    ...
    protected function decodeJwtTokenCookie($request) {
        return (array) JWT::decode(
                        $this->encrypter->decrypt($request->cookie(Passport::cookie())), $this->encrypter->getKey(), ['HS256']
        );
    }
